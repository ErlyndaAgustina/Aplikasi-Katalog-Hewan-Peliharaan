...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    final filteredPets = petData.where((pet) {
      ...
      final jenis = pet['jenis'].toString().toLowerCase();
      final input = query.toLowerCase();

      return nama.contains(input) || jenis.contains(input);
    }).toList();
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: "Cari hewan kesayanganmu...",
                hintStyle: TextStyle(color: Colors.grey[600]),
                prefixIcon: const Icon(Icons.search, color: Color(0xFFF06292)),
                suffixIcon: query.isNotEmpty
                    ? IconButton(
                        icon: const Icon(Icons.clear, color: Color(0xFFF06292)),
                        onPressed: () {
                          setState(() {
                            query = '';
